...
public class NodeMultiple {
	...
	public NodeMultiple getDaughter(int i) {
		if (NODE_MAX_ARITY < i || 0 > i) ErrorNaiveHandler.abort(ERROR_MSG_INDEX_OUT_OF_RANGE+"@"+getClass()+".getDaughter()");
		return daughters[i];
	}
	...
	public void setDaughter(NodeMultiple daughter, int i) {
		if (NODE_MAX_ARITY < i || 0 > i) ErrorNaiveHandler.abort(ERROR_MSG_INDEX_OUT_OF_RANGE+"@"+getClass()+".setDaughter()");
		daughter[i] = daughter;
	}
